...
<body>
  <header>
    <div class="nav-container">
      ...
      <nav class="nav-right">
        <div class="nav-links">
  <a href="${pageContext.request.contextPath}/directory">Home</a>
    ...
    <div class="box">
      ...
      <div class="image-section">
        <div class="overlay">
          ...
          <button onclick="window.location.href='${pageContext.request.contextPath}/register'" class="signup-btn">Sign Up</button>
        </div>
      </div>
    </div>
  </main>
